...
import com.hsr.game.ws.chat.ChatHallHandler;
import com.hsr.game.ws.cmd.service.CmdActionGameHandler;
import com.hsr.game.ws.yxw.figure.service.YxwGameFigureHandler;
import com.hsr.game.ws.heartbeat.HeartBeatHandler;
...
public class WsBaseHandler {
    ...
    @Autowired
    private CmdActionGameHandler cmdActionGameHandler;
    ...
    private void registerHandler() {
        ...
        handlers.put(BaseProtoType.BASE_CMD_ACTION_GAME, cmdActionGameHandler);
