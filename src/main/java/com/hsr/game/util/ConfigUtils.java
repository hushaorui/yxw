...
public abstract class ConfigUtils {
    ...
    public static <T> T getYxwConfig(Class<?> clazz, boolean useBase64) throws IOException, InstantiationException, IllegalAccessException {
        ...
        if (!file.exists()) {
            ...
            return (T) initYxwConfig(file, clazz, ! forceReset, useBase64);
        } else {
            if (forceReset) {
                return (T) initYxwConfig(file, clazz, ! forceReset, useBase64);
            }
     ...
     * 初始化主配置
     */
    private static <T> T initYxwConfig(File file, Class clazz, boolean writeToFile, boolean useBase64) throws IOException, IllegalAccessException, InstantiationException {
