...
import com.hsr.game.yxw.common.anno.SynToClientConfig;
import com.hsr.game.yxw.common.em.card.YxwCardType;
import com.hsr.game.yxw.config.card.YxwCardBaseInfoConfig;
import com.hsr.game.yxw.config.card.YxwMonsterCardInfoConfig;
import com.hsr.game.yxw.config.figure.YxwGameFigureInfoConfig;
import com.hsr.game.yxw.config.goods.YxwGoodsInfoConfig;
import com.hsr.game.yxw.config.language.YxwLanguageConfig;
import com.hsr.game.yxw.info.*;
import com.hsr.game.util.ConfigUtils;
...
public class YxwGameInfoManager {
    ...
    /** 所有需要发送给客户端的配置 */
    private Map<String, List<? extends LongIdInfoIF>> allCfgMap;
    ...
    private void loadAllFromYamlFile() {
        ...
        Map<String, List<? extends LongIdInfoIF>> allCfgMap = new HashMap<>();
            ...
            if (InitializedConfig.class.isAssignableFrom(fieldType)) {
                ...
                try {
                    ...
                    if (synToClientConfig != null) {
                        ...
                        if (allCfgMap.containsKey(name)) {
                            log.error("存在重复名称的配置名称：" + name);
                        }
